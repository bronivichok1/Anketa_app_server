    ...
    async create(req, res, next) {
        try {
           ...
           if (cathRes && cathRes.length) {
            ...
            uchWork: uchWorkO ? Number(uchWorkO.ball_value/Number(stavkaO.selectvalue)).toFixed(2) : 0, 
            uchMetWork: uchMetWorkO ? Number(uchMetWorkO.ball_value/Number(stavkaO.selectvalue)).toFixed(2) : 0,
            nauchWork: nauchWorkO ? Number(nauchWorkO.ball_value/Number(stavkaO.selectvalue)).toFixed(2) : 0,
            vospitWork: vospitWorkO ? Number(vospitWorkO.ball_value/Number(stavkaO.selectvalue)).toFixed(2) : 0,
            lechWork: lechWorkO ? Number(lechWorkO.ball_value/Number(stavkaO.selectvalue)).toFixed(2) : 0,
            mejWork: mejWorkO ? Number(mejWorkO.ball_value/Number(stavkaO.selectvalue)).toFixed(2) : 0,
            indXirsh: indXirshO ? Number(indXirshO.ball_value/Number(stavkaO.selectvalue)).toFixed(2) : 0,
            indXirshScop: indXirshScopO ? Number(indXirshScopO.ball_value/Number(stavkaO.selectvalue)).toFixed(2) : 0,
            colvoScop: colvoScopO ? Number(colvoScopO.ball_value/Number(stavkaO.selectvalue)).toFixed(2) : 0,
            colvoWoS: colvoWoSO ? Number(colvoWoSO.ball_value/Number(stavkaO.selectvalue)).toFixed(2) : 0,
            covidWork: covidWorkO ? Number(covidWorkO.ball_value/Number(stavkaO.selectvalue)).toFixed(2) : 0,
        }
            ...
            for (let i = 0; i < users.length; i++) {
                ...
                if(ownRes && ownRes.length) {
                    ...
                    if(ownReports && ownReports.length) {
                       ...
                       uchMetWork: uchMetWork ? Number(uchMetWork.ball_value/Number(stavka.selectvalue)).toFixed(2) : 0,
                       dolj: dolj.selectvalue, stepen: stepen.selectvalue, age: age.selectvalue,
                        nauchWork: nauchWork ? Number(nauchWork.ball_value/Number(stavka.selectvalue)).toFixed(2) : 0,
                        vospitWork: vospitWork ? Number(vospitWork.ball_value/Number(stavka.selectvalue)).toFixed(2) : 0,
                        lechWork: lechWork ? Number(lechWork.ball_value).toFixed(2) : 0,
                        mejWork: mejWork ? Number(mejWork.ball_value/Number(stavka.selectvalue)).toFixed(2) : 0,
