...
const cathResponsiblesRouter = require('./cathResponsiblesRouter');
...
const cathValueRouter = require('./cathValueRouter');
...
router.use('/cathResponsibles', cathResponsiblesRouter);
...
router.use('/cathValue', cathValueRouter);
